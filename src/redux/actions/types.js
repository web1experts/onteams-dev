module.exports = {
    ...
    ACCOUNT_CLOSE_SUCCESS: "ACCOUNT_CLOSE_SUCCESS",
    ...
    DEFAULT_COMPANY_UPDATE_SUCCESS: "DEFAULT_COMPANY_UPDATE_SUCCESS",
    ...
    PUT_TASK_SUCCESS_SOCKET: "PUT_TASK_SUCCESS_SOCKET",
    ...
    MEMBERS_REORDER: "MEMBERS_REORDER",
    PUT_INVITE_SUCCESS: "PUT_INVITE_SUCCESS",
    LIST_REQUESTS_SUCCESS: "LIST_REQUESTS_SUCCESS",
    LIST_REQUESTS_FAILED: "LIST_REQUESTS_FAILED",
    OWNERSHIP_REQUEST_SUCCESS: "OWNERSHIP_REQUEST_SUCCESS",
    ...
    CLIENTS_REORDER: "CLIENTS_REORDER",
    ...
    VALIDATE_WS_OTP_SUCCESS: "VALIDATE_WS_OTP_SUCCESS",
    VALIDATE_ACC_PASSWORD_SUCCESS: "VALIDATE_ACC_PASSWORD_SUCCESS",
    VALIDATE_ACC_OTP_SUCCESS: "VALIDATE_ACC_OTP_SUCCESS",
    ...
    CURRENT_RECORDED_ACTIVITY_SUCCESS: "CURRENT_RECORDED_ACTIVITY_SUCCESS",
    ...
    UPDATE_POST_LIST_COMMENT:"UPDATE_POST_LIST_COMMENT",
    ...
    ATTENDANCE_SUMMARY_SUCCESS: "ATTENDANCE_SUMMARY_SUCCESS",
    ATTENDANCE_EXCEL_SUCCESS: "ATTENDANCE_EXCEL_SUCCESS",
    ATTENDANCE_STATUS_LIST_SUCCESS: "ATTENDANCE_STATUS_LIST_SUCCESS",
    ATTENDANCE_STATUS_SAVE_SUCCESS: "ATTENDANCE_STATUS_SAVE_SUCCESS",
    ATTENDANCE_SHIFTS_SAVE_SUCCESS: "ATTENDANCE_SHIFTS_SAVE_SUCCESS",
    ATTENDANCE_SHIFTS_GET_SUCCESS: "ATTENDANCE_SHIFTS_GET_SUCCESS",
    ATTENDANCE_SHIFT_DELETE_SUCCESS: "ATTENDANCE_SHIFT_DELETE_SUCCESS",
    ...
    SINGLE_PROJECT_REPORTS: "SINGLE_PROJECT_REPORTS",
    REPORTS_REMARKS_SUCCESS: "REPORTS_REMARKS_SUCCESS",

    PERMISSIONS_SUCCESS: "PERMISSIONS_SUCCESS",
    PERMISSIONS_FAILED: "PERMISSIONS_FAILED",
    ROLE_SUCCESS: "ROLE_SUCCESS",
    ASSIGN_TEAMS_AND_MEMBERS: "ASSIGN_TEAMS_AND_MEMBERS",
    ROLE_DELETE_SUCCESS: "ROLE_DELETE_SUCCESS",
    MANUAL_TIME_LIST: "MANUAL_TIME_LIST",
    MANUAL_ENTRY_DATA: "MANUAL_ENTRY_DATA",
    REPORTS_META_SUCCESS: "REPORTS_META_SUCCESS",
    MEMBER_REPORT_SUCCESS: "MEMBER_REPORT_SUCCESS",
    SUBSCRIPTION_ERROR: "SUBSCRIPTION_ERROR",
    SUBSCRIPTION_CANCEL: "SUBSCRIPTION_CANCEL",
    SUBSCRIPTION_SUCCESS: "SUBSCRIPTION_SUCCESS",
    BILLING_SUCCESS: "BILLING_SUCCESS0",
    SUBSCRIPTION_DATA: "SUBSCRIPTION_DATA",
    SUBSCRIPTION_SCHEDULED: "SUBSCRIPTION_SCHEDULED",
    HAS_TRIAL_PLAN: "HAS_TRIAL_PLAN",
    SUBSCRIPTION_INVOICE_SUCCESS: "SUBSCRIPTION_INVOICE_SUCCESS",
    ...
    FIELDS_REORDER: "FIELDS_REORDER",

    
    SYSTEM_FIELDS_LIST: "SYSTEM_FIELDS_LIST",
    SYSTEM_FIELD_COMMON_ERROR: "SYSTEM_FIELD_COMMON_ERROR",
    SYSTEM_UPDATE_FIELD_SUCCESS: "SYSTEM_UPDATE_FIELD_SUCCESS",

    // TEAM TYPES
    TEAM_COMMON_ERROR: "TEAM_COMMON_ERROR",
    ...
    TEAM_CLEAR_MESSAGES: "TEAM_CLEAR_MESSAGES",
    OPTIONS_ERROR: "OPTIONS_ERROR",
    OPTION_SUCCESS: "OPTION_SUCCESS",
    ALL_OPTION_SUCCESS: "ALL_OPTION_SUCCESS",
